...
const EMPTY_METRICS: GlassMetrics = {
  ...
  sourceState: "invalid", captureScrollX: 0, captureScrollY: 0, scrollDeltaX: 0, scrollDeltaY: 0,
  overscanX: 0, overscanY: 0, overscanRemaining: 0, textureUploadMs: 0,
  captureTraversalMs: 0, captureRasterMs: 0, bitmapPreparationMs: 0, captureRegion: "viewport", textureBytes: 0,
